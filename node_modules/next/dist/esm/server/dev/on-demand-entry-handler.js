 ...
 */ async function findPagePathData(rootDir, page, extensions, pagesDir, appDir) {
    ...
    let pagePath = null;
    if (isMiddlewareFile(normalizedPagePath) || isInstrumentationHookFile(normalizedPagePath)) {
            ...
            try {
                ...
                await runDependingOnPageType({
                    ...
                    onServer: ()=>{
                        ...
                        if (entries[edgeServerEntry] && !isInstrumentationHookFile(pagePathData.page)) {
                    ...
                    onEdgeServer: ()=>{
                        ...
                        if (entries[serverEntry] && !isInstrumentationHookFile(pagePathData.page)) {
