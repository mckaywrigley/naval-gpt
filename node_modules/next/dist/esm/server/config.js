...
function assignDefaults(dir, userConfig, silent = false) {
    var ref12, ref3, ref4, ref5, ref6, ref7;
    ...
    if (Array.isArray((ref12 = result.experimental) == null ? void 0 : ref12.outputFileTracingIgnores)) {
    ...
    if (result == null ? void 0 : result.images) {
        ...
        if (images.domains) {
            ...
            // this resource
            if ((ref11 = config.assetPrefix) == null ? void 0 : ref11.startsWith("http")) {
        ...
        const remotePatterns = result == null ? void 0 : (ref9 = result.images) == null ? void 0 : ref9.remotePatterns;
        if (remotePatterns) {
        ...
        const unoptimized = result == null ? void 0 : (ref10 = result.images) == null ? void 0 : ref10.unoptimized;
