    ...
    loader({
        oneOf: [
            ...
            ctx.hasAppDir ? markRemovable({
                ...
                use: [
                    require.resolve("../../../loaders/next-flight-css-loader"),
                    ...getCssModuleLoader(ctx, true, lazyPostCSSInitializer, sassPreprocessors), 
                ]
            }) : null,
            markRemovable({
                sideEffects: false,
                test: regexSassModules,
                issuerLayer: PAGES_LAYER_RULE,
                use: getCssModuleLoader(ctx, false, lazyPostCSSInitializer, sassPreprocessors)
            }), 
        ].filter(nonNullable)
            ...
            oneOf: [
                ...ctx.hasAppDir ? [
                    ...
                    markRemovable({
                        ...
                        use: [
                            require.resolve("../../../loaders/next-flight-css-loader"),
                            ...getGlobalCssLoader(ctx, true, lazyPostCSSInitializer, sassPreprocessors), 
                        ]
                    }), 
                ] : [],
                markRemovable({
                ...
                markRemovable({
                    ...
                    issuer: allowedPagesGlobalCSSIssuer,
                    issuerLayer: PAGES_LAYER_RULE,
                    use: getGlobalCssLoader(ctx, false, lazyPostCSSInitializer, sassPreprocessors)
                }), 
            ].filter(nonNullable)
        }));
