...
function AlternatesMetadata({ alternates  }) {
    ...
    }) : null, alternates.languages ? Object.entries(alternates.languages).map(([locale, url])=>url ? /*#__PURE__*/ _react.default.createElement("link", {
            key: locale,
            rel: "alternate",
            hrefLang: locale,
            href: url.toString()
        }) : null) : null, alternates.media ? Object.entries(alternates.media).map(([media, url])=>url ? /*#__PURE__*/ _react.default.createElement("link", {
            key: media,
            rel: "alternate",
            media: media,
            href: url.toString()
