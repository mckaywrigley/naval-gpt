...
export declare class RequestAsyncStorageWrapper implements AsyncStorageWrapper<RequestStore, RequestContext> {
     ...
     */
    wrap<Result>(storage: AsyncLocalStorage<RequestStore>, context: RequestContext, callback: () => Result): Result;
    /**
     * @deprecated instance method should be used in favor of the static method
     */
    static wrap<Result>(storage: AsyncLocalStorage<RequestStore>, { req, res, renderOpts }: RequestContext, callback: () => Result): Result;
}
