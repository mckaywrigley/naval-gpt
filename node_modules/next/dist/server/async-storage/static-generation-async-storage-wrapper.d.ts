...
export declare class StaticGenerationAsyncStorageWrapper implements AsyncStorageWrapper<StaticGenerationStore, RequestContext> {
    wrap<Result>(storage: AsyncLocalStorage<StaticGenerationStore>, context: RequestContext, callback: () => Result): Result;
    /**
     * @deprecated instance method should be used in favor of the static method
     */
    static wrap<Result>(storage: AsyncLocalStorage<StaticGenerationStore>, { pathname, renderOpts }: RequestContext, callback: () => Result): Result;
}
