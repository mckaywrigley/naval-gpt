...
async function renderToHTMLOrFlight(req, res, pathname, query, renderOpts) {
   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const createComponentTree = async ({ createSegmentPath , loaderTree: tree , parentParams , firstItem , rootLayoutIncluded , injectedCSS  })=>{
       ...
       */ const currentParams = // Handle null case where dynamic param is optional
        ...
        const streamToBufferedResult = async (renderResult)=>{
            ...
            const writable = {
                write (chunk) {
                    renderChunks.push((0, _nodeWebStreamsHelper).decodeText(chunk));
                },
                end () {},
                destroy () {}
            };
