 ...
 */ async function findPagePathData(rootDir, page, extensions, pagesDir, appDir) {
    ...
    let pagePath = null;
    if ((0, _utils).isMiddlewareFile(normalizedPagePath) || (0, _utils).isInstrumentationHookFile(normalizedPagePath)) {
        ...
        async ensurePage ({ page , clientOnly , appPaths =null , match  }) {
            ...
            try {
                ...
                const addEntry = (compilerType)=>{
                    ...
                    if (entries[entryKey] && // there can be an overlap in the entryKey for the instrumentation hook file and a page named the same
                    ...
                    !(0, _utils).isInstrumentationHookFilename(entries[entryKey].bundlePath)) {
                ...
                const pageType = pagePathData.bundlePath.startsWith("pages/") ? "pages" : pagePathData.bundlePath.startsWith("app/") ? "app" : "root";
                await (0, _entries).runDependingOnPageType({
                    ...
                    onServer: ()=>{
                        ...
                        if (entries[edgeServerEntry] && !(0, _utils).isInstrumentationHookFile(pagePathData.page)) {
                    ...
                    onEdgeServer: ()=>{
                        ...
                        if (entries[serverEntry] && !(0, _utils).isInstrumentationHookFile(pagePathData.page)) {
